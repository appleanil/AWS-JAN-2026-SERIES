# Class Brief Practices

1. Create Alias Names also
2. Create a IAM User1, IAM User2, IAM User3...
3. Create IAM USer1 with ---> Add user to group (Means later also we can give Add Permissions).
4. Create IAM User2 with ---> Copy Permissions (means same permissions for IAM User 1).
5. Create IAM User3 with ---> Attach policies directly (means directly gives Adminaccess).
6. Create a Group Name of DevOps-Admin ---> Add all IAM Users to that DevOps-Admin.
7. 
